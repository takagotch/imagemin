...
test('output error corrupt images', async t => {
...
test('throw on wrong input', async t => {
  await t.throwsAsync(imagemin('foo'), /**/);
  await t.throwsAsync(imagemin.buffer('foo'), /**/);
});
...
test('return processed buffer it is a bad optimization', async t => {
